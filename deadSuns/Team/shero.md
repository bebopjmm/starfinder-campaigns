...
| ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|Mod (Val)| +0 (10) | +2 (14) | -1 (8) | +1 (13) | +3 (16) | +1 (12) |
...
### Priest (The Green Faith)

- **Theme Knowledge**:
  - Reduce the DC of Culture and Mysticism checks to recall knowledge about religious traditions, religious symbols, and famous religious leaders by 5.
  - +1 theme bonus to Mysticism checks.

### Mystic (Xenodruid)

- **Healing Touch (5hp)**: Once per day, Shero can spend 10 minutes to magically heal an ally up to 5hp per mystic level.
